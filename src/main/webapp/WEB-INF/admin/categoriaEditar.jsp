...
<head>
    ...
    <title>
        ZapaStore |
        <c:out value="${isEdit ? 'Editar Categoría' : 'Registrar Nueva Categoría'}"/>
    </title>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="campo">
                            ...
                            <select id="estado" name="estado" class="input-select" required>
                                <option value="Activo"
                                        <c:if test="${categoria.estado eq 'Activo'}">selected</c:if>>
                                    Activo
                                </option>

                                <option value="Inactivo"
                                        <c:if test="${categoria.estado eq 'Inactivo'}">selected</c:if>>
                                    Inactivo
                                </option>
                            </select>
                        </div>
